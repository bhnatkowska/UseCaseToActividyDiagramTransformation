UseCaseToActivityDiagramTransformation - a zipped version of the Visual Paradigm plug-in which generates an activity diagram from a use-case textual specification.
